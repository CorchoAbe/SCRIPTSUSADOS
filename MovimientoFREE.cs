...
public class MovimientoFREE : MonoBehaviour
{
    ...
    public float speed = 10f; // Velocidad normal
    public float runSpeed = 20f; // Velocidad cuando se corre
    ...
    void Update()
    {
        ...
        // Comprobar si el jugador está presionando la tecla Shift para correr
